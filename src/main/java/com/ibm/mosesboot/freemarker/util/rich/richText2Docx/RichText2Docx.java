package com.ibm.mosesboot.freemarker.util.rich.richText2Docx;

import com.ibm.mosesboot.freemarker.util.rich.FreemarkerUtils;
...
public class RichText2Docx {
     ...
     * @param jurl 保存地址
     */
    public String resolveHtml(String data, String jurl) throws InvalidFormatException, IOException {
//        Template template = getTemplate();
        Template template = FreemarkerUtils.getTemplate("template");
        if (template != null) {
