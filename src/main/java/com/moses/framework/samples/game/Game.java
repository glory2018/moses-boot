...
public class Game extends Applet {
    ...
    public void init() {
        ...
        //����ͼƬ������
        myImage0 = getImage(getCodeBase(), "com/moses/framework/samples/game/b0.jpg");
        myImage1 = getImage(getCodeBase(), "com/moses/framework/samples/game/b1.jpg");
        myImage2 = getImage(getCodeBase(), "com/moses/framework/samples/game/b2.jpg");
        myImage3 = getImage(getCodeBase(), "com/moses/framework/samples/game/b3.jpg");
        myImage4 = getImage(getCodeBase(), "com/moses/framework/samples/game/b4.jpg");
        myImage5 = getImage(getCodeBase(), "com/moses/framework/samples/game/b5.jpg");
        myImage6 = getImage(getCodeBase(), "com/moses/framework/samples/game/b6.jpg");
        myImage7 = getImage(getCodeBase(), "com/moses/framework/samples/game/b7.jpg");
        myImage8 = getImage(getCodeBase(), "com/moses/framework/samples/game/b8.jpg");
        myImage9 = getImage(getCodeBase(), "com/moses/framework/samples/game/b9.jpg");
        myAudio = getAudioClip(getCodeBase(), "com/moses/framework/samples/game/ReadyGo.wav");
        myAudio1 = getAudioClip(getCodeBase(), "com/moses/framework/samples/game/ReadyGo.wav");
        myAudio2 = getAudioClip(getCodeBase(), "com/moses/framework/samples/game/ReadyGo.wav");
        myAudio3 = getAudioClip(getCodeBase(), "com/moses/framework/samples/game/ReadyGo.wav");
        myAudio4 = getAudioClip(getCodeBase(), "com/moses/framework/samples/game/ReadyGo.wav");
        myAudio5 = getAudioClip(getCodeBase(), "com/moses/framework/samples/game/ReadyGo.wav");
        myAudio6 = getAudioClip(getCodeBase(), "com/moses/framework/samples/game/ReadyGo.wav");
        //��ʼ�ٶȿؼ�
